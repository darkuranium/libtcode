...
size_t tcode_char_utf8_normalize(tc_char8* out, const tc_char8* in, int strict);
size_t tcode_char_utf8_to_utf16(tc_char16* out, const tc_char8* in, int strict);
size_t tcode_char_utf8_to_utf32(tc_char32* out, const tc_char8* in, int strict);

size_t tcode_char_utf16_normalize(tc_char16* out, const tc_char16* in, int strict);
size_t tcode_char_utf16_to_utf8(tc_char8* out, const tc_char16* in, int strict);
size_t tcode_char_utf16_to_utf32(tc_char32* out, const tc_char16* in, int strict);

size_t tcode_char_utf32_to_utf8(tc_char8* out, const tc_char32* in, int strict);
size_t tcode_char_utf32_to_utf16(tc_char16* out, const tc_char32* in, int strict);
